...
# from solver.networks.resnetd import ResNetD
...
def parse_option():
    ...
    parser.add_argument('--use_early_stop', action='store_true', help='Enable early stopping')
    ...
    opt.save_folder = os.path.join(BASE_DIR, 'models', opt.model_name)
